...
class Settings
{
    ...
    public function render_support(): void
    {
        ...
        $faqs = apply_filters('wpify_dashboard_support_faqs', array(array('title' => __('How do the pricing plans work?', 'wpify-core'), 'content' => __('When you purchase the plugin, you receive support and updates for one year. After this period, the license will automatically renew at a discounted price.', 'wpify-core')), array('title' => __('Will the plugin work if I do not renew my license?', 'wpify-core'), 'content' => __('Yes, the plugin will continue to work, but you will no longer have access to updates and support.', 'wpify-core')), array('title' => __('I need a feature that the plugin does not currently support.', 'wpify-core'), 'content' => __('Let us know, and we will consider adding the requested functionality.', 'wpify-core'))));
        ?>
        <div class="wpify-dashboard__wrap wrap">
            <div class="wpify-dashboard__content">
                <h1><?php 
