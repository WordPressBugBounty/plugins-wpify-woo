...
if (!\function_exists('WpifyWooDeps\wpify_woo_core_prefer_latest')) {
    function wpify_woo_core_prefer_latest(): void
    {
        static $last_count = 0;
        if (!\class_exists(\WpifyWooDeps\Composer\Autoload\ClassLoader::class, \false)) {
            return;
        }
        $loaders = \WpifyWooDeps\Composer\Autoload\ClassLoader::getRegisteredLoaders();
        ...
        if ($best_vendor && isset($loaders[$best_vendor])) {
            ...
            if ($best_loader instanceof \WpifyWooDeps\Composer\Autoload\ClassLoader) {
                $best_loader->unregister();
                $best_loader->register(\true);
            }
        }
    }
}
if (!\function_exists('WpifyWooDeps\wpify_woo_core_get_version_from_vendor')) {
...
if (!\function_exists('WpifyWooDeps\wpify_woo_core_extract_version_from_installed')) {
